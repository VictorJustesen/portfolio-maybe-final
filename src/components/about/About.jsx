...
og jeg søger derfor et studiejob.
    ...
    <h5 className='text'>
    Jeg kan godt lide at smarte løsninger som er scalerbare, justerbare og giver mening. Jeg kan lidt af hvert, med ekstra kompetence inden for web development. Hvis du mangler en som lærer hurtigt så tog ikke med at skrive til mig!  
    </h5>
    </div>
    </div>
</section>
